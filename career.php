...
<?php
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $relskills = $_POST['relskills'];
        $linkedin = $_POST['linkedin'];
        $startdate = $_POST['startdate'];
        $reference = $_POST['reference'];
        $insertion = "INSERT INTO hiring VALUES(null,'$fullname','$email','$phone','$address','$position','$coverletter','$edu','$experience','$relskills','$linkedin','$startdate','$reference')";
...
<form method="post">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <textarea id="cover-letter" name="coverletter" rows="4" required placeholder="I can clean homes.. etc"></textarea>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <textarea id="skills" name="relskills" rows="3" placeholder="List any relevant skills or certifications"></textarea>
        </div>
    </div>
    <div class="form-row">
        <div class="form-group">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <textarea id="references" name="reference" rows="3" placeholder="Provide names and contact details of at least two references"></textarea>
        </div>
    </div>
    <div class="form-group">
        <button type="submit" class="submit-button"><a href="#">Submit Application</a></button>
    </div>
</form>
